...
import com.msib.accountingproject.databinding.ActivityNewIrrBinding
import com.msib.accountingproject.model.CashModel

class NewIRRActivity : AppCompatActivity(), View.OnClickListener {

    private var _binding: ActivityNewIrrBinding? = null
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        _binding = ActivityNewIrrBinding.inflate(layoutInflater)
